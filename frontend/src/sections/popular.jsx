      ...
      >
        ...
        <div id="bottom" className='w-full grid lg:grid-cols-3 grid-cols-1 lg:justify-center justify-start items-center gap-6'>
           <div data-aos="slide-up" data-aos-delay="200" className='flex justify-center lg:items-center gap-8 w-full'>
            <h1 className="text-black text-7xl font-semibold dark:text-white">1469</h1>
            <h1 className="dark:text-white">ACTIVE <br /> LISTINGS</h1>
           </div>
           <div data-aos="slide-up" data-aos-delay="200" className='flex justify-center lg:items-center gap-8 w-full'>
            <h1 className="text-black text-7xl font-semibold dark:text-white">9369</h1>
            <h1 className="dark:text-white">READY TO <br /> MOVE-IN</h1>
           </div>
           <div data-aos="slide-up" data-aos-delay="200" className='flex justify-center lg:items-center gap-8 w-full'>
            <h1 className="text-black text-7xl font-semibold dark:text-white">869</h1>
            <h1 className="dark:text-white">ON-GOING <br /> PROJECTS</h1>
           </div>
        </div>
      </section>
    </div>
