  ...
  return (
    ...
    >
      <section
        ...
        } lg:w-[95%] w-full h-fit m-auto rounded-xl flex flex-col justify-center items-start lg:px-20 py-20 px-6 gap-10`}
      >
        <div className="flex flex-col justify-center items-start gap-4">
          <h1 data-aos="zoom-in" className="text-red-500 dark:text-white">OUR SERVICES</h1>
          <h1 data-aos="zoom-in" className="text-black font-semibold leading-10 dark:text-white text-[40px]">Top Real Estate <br /> Services Available
          </h1>
        </div>
        <div id="service-box" className="grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-6">
          {
            service.map((item, index) => (
             <div data-aos="zoom-in" data-aos-delay="200" key={index} className="bg-white dark:bg-black h-[350px] px-8 py-16 flex flex-col justify-center items-start gap-4 rounded-xl border-b-[5px] border-red-600 hover:bg-red-300 cursor-pointer">
              ...
              <button className="border-b-2 border-red-600 hover:text-white hover:border-white text-red-600 font-semibold p-0 dark:text-white">Read More</button>
             </div> 
            ))
          }
        </div>
